...
/***/ "./hendlers/calcDate/getDateDiff.js":
/*!******************************************!*\
  !*** ./hendlers/calcDate/getDateDiff.js ***!
  \******************************************/
...
const getDateDiff = (dateFrom, dateTo) => {
  ...
  const dateFromObj = luxon__WEBPACK_IMPORTED_MODULE_0__.DateTime.fromISO(dateFrom)
  const dateToObj = luxon__WEBPACK_IMPORTED_MODULE_0__.DateTime.fromISO(dateTo)
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _render_printResult_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../render/printResult.js */ "./render/printResult.js");
/* harmony import */ var _calcDate_getDateDiff_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./calcDate/getDateDiff.js */ "./hendlers/calcDate/getDateDiff.js");
/* harmony import */ var _timer_timer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./timer/timer.js */ "./hendlers/timer/timer.js");
...
form.onsubmit = (event) => {
  ...
  const dateDiff = (0,_calcDate_getDateDiff_js__WEBPACK_IMPORTED_MODULE_1__.getDateDiff)(firstInput, secondInput)
  console.log(dateDiff)

  if (!firstInput || !secondInput) {
    (0,_render_printResult_js__WEBPACK_IMPORTED_MODULE_0__.printError)('Oooppppsss - Введите дату!!!!')
  } else {
    (0,_render_printResult_js__WEBPACK_IMPORTED_MODULE_0__.printResult)(dateDiff)
  }
}
...
formTimer.onsubmit = (event) => {
  ...
  ;(0,_timer_timer_js__WEBPACK_IMPORTED_MODULE_2__.startStop)()
  ;(0,_timer_timer_js__WEBPACK_IMPORTED_MODULE_2__.countdownTimer)(deadline)
}

/***/ }),

/***/ "./hendlers/timer/declension.js":
/*!**************************************!*\
  !*** ./hendlers/timer/declension.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "declensionNum": () => (/* binding */ declensionNum)
/* harmony export */ });
...
const countdownTimer = (date) => {
  const runTimer = () => {
    ...
    if (stopTimer || diff == NaN) {
      ...
      (0,_render_printResult_js__WEBPACK_IMPORTED_MODULE_0__.printTimer)(days, hours, minutes, seconds)
    }
  }
...
/* harmony export */ });
/* harmony import */ var _hendlers_timer_declension_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../hendlers/timer/declension.js */ "./hendlers/timer/declension.js");
/* harmony import */ var _hendlers_timer_timer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../hendlers/timer/timer.js */ "./hendlers/timer/timer.js");
...
const printTimer = (days,hours,minutes,seconds) => {
  $days.textContent = days < 10 ? '0' + days : days
  $hours.textContent = hours < 10 ? '0' + hours : hours
  $minutes.textContent = minutes < 10 ? '0' + minutes : minutes
  $seconds.textContent = seconds < 10 ? '0' + seconds : seconds
  $days.dataset.title = (0,_hendlers_timer_declension_js__WEBPACK_IMPORTED_MODULE_0__.declensionNum)(days, ['день', 'дня', 'дней'])
  $hours.dataset.title = (0,_hendlers_timer_declension_js__WEBPACK_IMPORTED_MODULE_0__.declensionNum)(hours, ['час', 'часа', 'часов'])
  $minutes.dataset.title = (0,_hendlers_timer_declension_js__WEBPACK_IMPORTED_MODULE_0__.declensionNum)(minutes, ['минута', 'минуты', 'минут'])
  $seconds.dataset.title = (0,_hendlers_timer_declension_js__WEBPACK_IMPORTED_MODULE_0__.declensionNum)(seconds, ['секунда', 'секунды', 'секунд'])
}

btnStop.addEventListener('click', ()=> {
  ;(0,_hendlers_timer_timer_js__WEBPACK_IMPORTED_MODULE_1__.startStop)()
})
...
/*!******************!*\
  ...
  \******************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _render_mainPage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./render/mainPage.js */ "./render/mainPage.js");
/* harmony import */ var _render_mainPage_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_render_mainPage_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _hendlers_main_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hendlers/main.js */ "./hendlers/main.js");
...
/******/ })()
;
//# sourceMappingURL=main.835b3420401ffcc1f10e.js.map